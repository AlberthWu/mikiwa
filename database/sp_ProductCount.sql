...
BEGIN
    ...
    if reportType = 0 then
		...
		SET @s =  (concat ("select count(id) rn from (select id,product_code,product_name,serial_number,product_type_id,product_type_name,product_division_id,product_division_code,product_division_name,uom_id,uom_code,lead_time,status_id,status_data,is_purchase,is_sales,is_production
